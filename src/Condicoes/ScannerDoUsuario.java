...
public class ScannerDoUsuario {
    public static void main(String[] args) {
        ...
        /*
         * Scanner = É um jeito de trazer o usuario para dentro da aplicaçao.
         * Objeito: O usuario vai criar um ninja e vamos validar os dados
         */
        //Abrir sempre o Scanner
        ...
        // Tratamento de dados
        if (idadeDoNinja >= 18) {
            System.out.println("Esse ninja ja é maior de idade e ja pode ir para missões fora da aldeia");
        } else {
